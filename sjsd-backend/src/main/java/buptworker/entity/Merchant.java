...
public class Merchant {
    ...
    public Merchant(int merchantID, String avatarURL, String merchantName, int typeId,String typeName, double deliveryFee, double packagingFeePerItem, double minimumOrderAmount, String openingHours, String phoneNumber, String merchantAddress, String merchantDescription) {
